...
Available on **Business and Enterprise** plans. Connect your SAML 2.0 identity provider (Okta, Azure AD, Google Workspace, etc.) for single sign-on. See [SAML Setup](/enterprise/saml-sso).

### OIDC / OAuth 2.0 + PKCE

Available on **Business and Enterprise** plans. For OpenID Connect-compatible IdPs:
...
Available on **Enterprise** plans only. Automate user lifecycle management from your IdP:
