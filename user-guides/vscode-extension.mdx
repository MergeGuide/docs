...
Python, JavaScript, TypeScript (including JSX/TSX), Java, Go, Ruby, PHP, C# (.NET), C/C++, Rust, SQL

Detection coverage follows your organization's active policies. Language support at the detection engine level extends to all 15 supported languages.
