...
| Team | $39/seat/mo | 5 seats | + SOC 2, HIPAA, EU AI Act, GDPR, OWASP ASVS L2, PolicyMerge, SBOM, OSCAL |
| Business | $79/seat/mo | 10 seats | + DORA, ISO 27001:2022, NIST SP 800-53, FedRAMP, StateRAMP, SAML/OIDC SSO, SCIM, RBAC, dedicated CSM |
| Enterprise | Custom | — | + NIS2, Colorado AI Act, custom detection rules, government tenant |
...
Yes, on Team plan and above. MergeGuide exports compliance posture as NIST OSCAL v1.1.2 — the machine-readable standard used by FedRAMP and major GRC platforms. Import the output directly into Drata, Vanta, Secureframe, Tugboat Logic, or any OSCAL-compatible tool.
...
**Business plan** additionally supports OSCAL webhooks for automated GRC platform delivery.

### Is MergeGuide SOC 2 compliant?

Yes. MergeGuide is SOC 2 Type II certified. Contact [sales@mergeguide.ai](mailto:sales@mergeguide.ai) for the audit report.
...
- **API key** — All plans
- **OAuth 2.0** — All plans
- **SAML 2.0 SSO** — Business and Enterprise
- **OIDC / OAuth 2.0 + PKCE** — Business and Enterprise
